...
export default function Connect(){
    ...
    return(
        <section className=" bg-[#FAFAFA] p-10 " >
            <div className='flex flex-col items-center justify-center gap-3 text-center ' >
                <h1 className="font-heading " >Connect With Us</h1>
                <p className="font-secondary text-[#1E1E1ECC] " >Whether it’s your first time or you’ve been with us for years, we’re here for you.</p>
            </div>

            <div className="flex mt-12 items-center justify-between p-4  " >
                {waysToConnect.map((connect)=>(
                <div className="w-[23%] border-[#E8E8E8] gap-4 text-center border rounded-xl bg-white p-8  flex flex-col items-center justify-center "  key={connect.id}>

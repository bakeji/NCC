...
const services =[
    ...
    return(
        <section className="flex flex-col justify-center items-center p-10 gap-8 " >
            ...
            <div className="flex items-center  justify-center p-10 gap-8" >
             {services.map((service, id)=>(
                <div key={id} className="w-[30%] border border-[#E8E8E8] flex flex-col gap-4  p-8 items-center text-center rounded-xl  " > 
                    <div>

...
export default function DeleteBlogModal({ blog, isOpen, onClose, onConfirm }: DeleteBlogModalProps) {
      ...
      >
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-lg font-semibold text-gray-900">Delete Blog Post</h2>
          </div>
          <button
            onClick={onClose}
